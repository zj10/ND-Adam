...
tf.app.flags.DEFINE_string('optimizer', 'ndadam',
                            'sgd, mom, adam, ndadam')
tf.app.flags.DEFINE_float('init_learning_rate', 0.001,
                            'Initial learning rate.')
tf.app.flags.DEFINE_float('weight_decay', 0.,
                            'L2 weight decay factor.')
tf.app.flags.DEFINE_float('bnsoftmax_scale', None,
                            'Scale of BN-Softmax. None if not use BN-Softmax.')
...
def evaluate(hps):
    ...
    while True:
        ...
        tf.logging.info('loss: %.5f, precision: %.5f, best precision: %.5f' %
...
def main(_):
    ...
    hps = resnet_model.HParams(batch_size=batch_size,
                               ...
                               bnsoftmax_scale=FLAGS.bnsoftmax_scale)
